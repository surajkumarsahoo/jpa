...
public class Channel implements Comparable<Channel>{
	...
	public Channel(int channelId, String channelName, double price, ChannelGroup channelGroup,
			Set<ChannelShow> shows) {
		super();
	...
	public int compareTo(Channel channel) {
		...
		if(result==0) {
			...
			if(this.channelName.compareTo(channelName)<0)
				result = -1;
			else if(this.channelName.compareTo(channelName)>0)
				result = 1;
			else
				result=0;
		}
